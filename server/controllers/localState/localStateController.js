/**
 * Endpoints to get or request a specific client state object.
 * This should be used to handle persistence of user changes to the
 * application such as color scheme and other state.
 */
const fs = require("fs");
